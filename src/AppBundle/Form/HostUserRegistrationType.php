...
class HostUserRegistrationType extends AbstractType
{
    ...
    {
        $builder
            ->add('firstName', null, array('label' => 'label.first_name', 'attr'=> array('required'=>true,'maxlength'=>"60",'class'=> 'form-control', 'placeholder'=>'label.first_name')))
            ->add('lastName', null, array('label' => 'label.last_name','attr'=> array('required'=>true,'maxlength'=>"60",'class'=> 'form-control', 'placeholder'=>'label.last_name')))
